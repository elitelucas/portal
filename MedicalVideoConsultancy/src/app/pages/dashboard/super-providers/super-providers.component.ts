...
@Component({
  selector: 'app-super-providers',
  templateUrl: './super-providers.component.html',
  styleUrls: ['./super-providers.component.css']
})

export class SuperProvidersComponent implements OnInit {
