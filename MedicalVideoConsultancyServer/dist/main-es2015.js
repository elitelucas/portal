...
/* harmony import */ var _patient_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./patient.service */ "./src/app/_services/patient.service.ts");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
...
class ProviderService {
    ...
    //portal end
    sendSMS(smsData) {
        const smsUrl = _patient_service__WEBPACK_IMPORTED_MODULE_0__["baseUrl"] + 'provider/invite-by-sms';
        this.trace("smsUrl:", smsUrl);
        return this.http.post(smsUrl, smsData);
    }
    getRoomData(userId) {
        const roomUrl = _patient_service__WEBPACK_IMPORTED_MODULE_0__["baseUrl"] + 'provider/room/' + userId;
        this.trace("roomUrl:", roomUrl);
        return this.http.get(roomUrl);
    }
    changeText(userId, text) {
        const textUrl = _patient_service__WEBPACK_IMPORTED_MODULE_0__["baseUrl"] + 'provider/text/' + userId;
        this.trace("changeText:", textUrl);
        return this.http.patch(textUrl, { text: text });
    }
    checkRoomExist(room) {
        const checkRoomUrl = _patient_service__WEBPACK_IMPORTED_MODULE_0__["baseUrl"] + 'provider/roomName/' + room;
    ...
    checkPatient(dni) {
        const checkPatientUrl = _patient_service__WEBPACK_IMPORTED_MODULE_0__["baseUrl"] + 'provider/checkPatient/' + dni;
        this.trace("checkPatientUrl:", dni);
        return this.http.get(checkPatientUrl);
    }
    postPatient(data) {
        const postPatientUrl = _patient_service__WEBPACK_IMPORTED_MODULE_0__["baseUrl"] + 'provider/postPatient';
    ...
    getAllPatientsData(value, field) {
        const patientUrl = _patient_service__WEBPACK_IMPORTED_MODULE_0__["baseUrl"] + 'provider/allPatients';
        let params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set("key", field).set("value", value);
        this.trace("getAllPatientsData:", patientUrl, params);
        return this.http.get(patientUrl, { params });
    }
    getInitPatientsData(value, field) {
        const patientUrl = _patient_service__WEBPACK_IMPORTED_MODULE_0__["baseUrl"] + 'provider/initPatients';
        let params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set("key", field).set("value", value);
        this.trace("getAllPatientsData:", patientUrl, params);
        return this.http.get(patientUrl, { params });
    }
    getConsult(id, startDate, endDate) {
        const patientUrl = _patient_service__WEBPACK_IMPORTED_MODULE_0__["baseUrl"] + 'provider/consult/patient/' + id;
    ...
    getFilterPatientsData(providerId, filterValue, key) {
        const patientUrl = _patient_service__WEBPACK_IMPORTED_MODULE_0__["baseUrl"] + 'provider/filterPatients/' + providerId + '/' + filterValue + '/' + key;
        this.trace("getFilterPatientsData:", patientUrl);
        return this.http.get(patientUrl);
    }
    getInitConsult(id) {
        const patientUrl = _patient_service__WEBPACK_IMPORTED_MODULE_0__["baseUrl"] + 'provider/consult/' + id;
        this.trace("getConsult:", patientUrl);
        return this.http.get(patientUrl);
    }
    getConsultInChat(patientId, providerId) {
        const patientUrl = _patient_service__WEBPACK_IMPORTED_MODULE_0__["baseUrl"] + 'provider/consultInChat';
        let params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set("patientId", patientId).set("providerId", providerId);
        this.trace("getConsultInChat:", patientUrl, params);
        return this.http.get(patientUrl, { params });
    }
    sendMail(from, email, subject, html) {
        //console.log('sdfsdfsdf')
        const mailUrl = _patient_service__WEBPACK_IMPORTED_MODULE_0__["baseUrl"] + 'provider/mail';
    ...
    getOneConsult(patientId, consultId) {
        const patientUrl = _patient_service__WEBPACK_IMPORTED_MODULE_0__["baseUrl"] + 'provider/oneConsult';
        let params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set("patientId", patientId).set("consultId", consultId);
        this.trace("getOneConsult:", patientUrl, params);
        return this.http.get(patientUrl, { params });
    }
    updateConsult(updateData) {
        const updateUrl = _patient_service__WEBPACK_IMPORTED_MODULE_0__["baseUrl"] + 'provider/updateConsult';
        this.trace("updateUrl:", updateUrl);
        return this.http.put(updateUrl, updateData);
    }
    getChart(patientDni) {
        const chartUrl = _patient_service__WEBPACK_IMPORTED_MODULE_0__["baseUrl"] + 'provider/getChart/' + patientDni;
        this.trace("getChart:", chartUrl, patientDni);
        return this.http.get(chartUrl);
    }
    editChart(updateData) {
        const updateUrl = _patient_service__WEBPACK_IMPORTED_MODULE_0__["baseUrl"] + 'provider/chart';
        this.trace("updateUrl:", updateUrl);
        return this.http.put(updateUrl, updateData);
    }
    getSignature(providerId) {
        /*console.log('providerId')
        console.log(providerId)*/
        const sigUrl = _patient_service__WEBPACK_IMPORTED_MODULE_0__["baseUrl"] + 'provider/getSignature/' + providerId;
        return this.http.get(sigUrl);
    }
    //I added end
    getPatient(value, field) {
        const patientUrl = _patient_service__WEBPACK_IMPORTED_MODULE_0__["baseUrl"] + 'provider/patientByField';
        let params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set("key", field).set("value", value);
    ...
    updatePatient(patientData) {
        const patientUrl = _patient_service__WEBPACK_IMPORTED_MODULE_0__["baseUrl"] + 'provider/patient';
        this.trace("patientUrl:", patientUrl, patientData);
        return this.http.put(patientUrl, patientData);
    }
    updatePatientOnChart(patientData) {
        const patientUrl = _patient_service__WEBPACK_IMPORTED_MODULE_0__["baseUrl"] + 'provider/patient/chart';
        this.trace("patientUrl:", patientUrl, patientData);
        return this.http.put(patientUrl, patientData);
    }
    getWaitingPatientsData(room) {
        const waitingPatientUrl = _patient_service__WEBPACK_IMPORTED_MODULE_0__["baseUrl"] + 'provider/patients-waiting/' + room;
        this.trace("getWaitingPatientsData:", waitingPatientUrl);
        return this.http.get(waitingPatientUrl);
    }
    createConsult(consult) {
        let createConsultUrl = _patient_service__WEBPACK_IMPORTED_MODULE_0__["baseUrl"] + "provider/consult";
        this.trace("createConsultUrl:", createConsultUrl);
        return this.http.post(createConsultUrl, consult);
    }
    closeConsult(consultId) {
        let createConsultUrl = _patient_service__WEBPACK_IMPORTED_MODULE_0__["baseUrl"] + "provider/consult/" + consultId + "/close";
        this.trace("createConsultUrl:", createConsultUrl);
        return this.http.patch(createConsultUrl, null);
    }
    getLastAttetionsPatientsDataProvider(userId) {
        const lastAttetionsPatientsUrl = _patient_service__WEBPACK_IMPORTED_MODULE_0__["baseUrl"] + 'provider/consult/provider/' + userId;
    ...
    getLastAttetionsPatientsDataPatient(patientId) {
        const lastAttetionsPatientsUrl = _patient_service__WEBPACK_IMPORTED_MODULE_0__["baseUrl"] + 'provider/consult/patient/' + patientId;
    ...
    getPlans() {
        const getPlansUrl = _patient_service__WEBPACK_IMPORTED_MODULE_0__["baseUrl"] + 'plans';
        return this.http.get(getPlansUrl);
    }
    sendSubcriptionData(data) {
        const subcriptionUrl = _patient_service__WEBPACK_IMPORTED_MODULE_0__["baseUrl"] + 'provider/subcription';
        return this.http.post(subcriptionUrl, data);
    }
    sendMailForSubscription(data) {
        const sendMailForSubscription = _patient_service__WEBPACK_IMPORTED_MODULE_0__["baseUrl"] + 'provider/sendMail';
        return this.http.post(sendMailForSubscription, data);
    }
    getPlansById(planId) {
        const getPlansUrl = _patient_service__WEBPACK_IMPORTED_MODULE_0__["baseUrl"] + 'plans/' + planId;
        return this.http.get(getPlansUrl);
    }
    getCard(providerId) {
        const getCardUrl = _patient_service__WEBPACK_IMPORTED_MODULE_0__["baseUrl"] + 'provider/card/' + providerId;
        return this.http.get(getCardUrl);
    }
    updateCard(data) {
        const updateCardUrl = _patient_service__WEBPACK_IMPORTED_MODULE_0__["baseUrl"] + 'provider/card';
        this.trace("updateCardUrl:", updateCardUrl);
        return this.http.put(updateCardUrl, data);
    }
    removeCard(cardId) {
        const deleteCardUrl = _patient_service__WEBPACK_IMPORTED_MODULE_0__["baseUrl"] + 'provider/card/' + cardId;
        this.trace("deletePlansUrl:", deleteCardUrl);
        return this.http.delete(deleteCardUrl);
    }
    createPlan(data) {
        const createPlanUrl = _patient_service__WEBPACK_IMPORTED_MODULE_0__["baseUrl"] + 'plans';
        return this.http.post(createPlanUrl, data);
    }
    updatePlans(data) {
        const updatePlansUrl = _patient_service__WEBPACK_IMPORTED_MODULE_0__["baseUrl"] + 'plans/update';
        this.trace("updatePlansUrl:", updatePlansUrl);
        return this.http.put(updatePlansUrl, data);
    }
    deletePlans(planId) {
        const deletePlansUrl = _patient_service__WEBPACK_IMPORTED_MODULE_0__["baseUrl"] + 'plans/' + planId;
...
const baseUrl = _environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].baseUrl + "users";
class UserService {
    constructor(http) {
        this.http = http;
    }
    ...
    updatePermission(userId, permission) {
        ...
        return this.http.put(updateUrl, { role: permission });
    }
    ...
    updateProfile(profile, id) {
        ...
        return this.http.put(profileUrl, { profile });
    }
    updateSigPay(sig, pay, id) {
        let updateSigPayUrl = baseUrl + "/update-sigPay/" + id;
        return this.http.put(updateSigPayUrl, { sigImgSrc: sig, payMethod: pay });
    }
    updatePayment(payment, id) {
        let updatePaymentUrl = baseUrl + "/updatePayment/" + id;
        return this.http.put(updatePaymentUrl, { payment });
    }
    updateSignature(signature, id) {
        let updateSignatureUrl = baseUrl + "/updateSignature/" + id;
        return this.http.put(updateSignatureUrl, { signature });
    }
    getPayData(id) {
...
/* harmony import */ var _layouts_default_default_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./layouts/default/default.component */ "./src/app/pages/layouts/default/default.component.ts");
/* harmony import */ var _layouts_default_toolbar_toolbar_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./layouts/default/toolbar/toolbar.component */ "./src/app/pages/layouts/default/toolbar/toolbar.component.ts");
/* harmony import */ var _layouts_default_menubar_menubar_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./layouts/default/menubar/menubar.component */ "./src/app/pages/layouts/default/menubar/menubar.component.ts");
/* harmony import */ var _layouts_default_footer_footer_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./layouts/default/footer/footer.component */ "./src/app/pages/layouts/default/footer/footer.component.ts");
/* harmony import */ var _helpers_auth_interceptor__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../_helpers/auth.interceptor */ "./src/app/_helpers/auth.interceptor.ts");
...
/* harmony import */ var _services_meet_room_service__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ../_services/meet-room.service */ "./src/app/_services/meet-room.service.ts");
/* harmony import */ var _video_room_video_room_component__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./video-room/video-room.component */ "./src/app/pages/video-room/video-room.component.ts");
/* harmony import */ var _layouts_admin_admin_component__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./layouts/admin/admin.component */ "./src/app/pages/layouts/admin/admin.component.ts");
/* harmony import */ var _meet_patient_meet_patient_component__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./meet-patient/meet-patient.component */ "./src/app/pages/meet-patient/meet-patient.component.ts");
/* harmony import */ var _meet_patient_meet_call_meet_call_component__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./meet-patient/meet-call/meet-call.component */ "./src/app/pages/meet-patient/meet-call/meet-call.component.ts");
/* harmony import */ var _meet_patient_pay_patient_pay_patient_component__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./meet-patient/pay-patient/pay-patient.component */ "./src/app/pages/meet-patient/pay-patient/pay-patient.component.ts");
/* harmony import */ var _meet_patient_wating_room_waiting_room_component__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ./meet-patient/wating-room/waiting-room.component */ "./src/app/pages/meet-patient/wating-room/waiting-room.component.ts");
/* harmony import */ var _meet_patient_feeback_feeback_component__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ./meet-patient/feeback/feeback.component */ "./src/app/pages/meet-patient/feeback/feeback.component.ts");
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_6__["AppComponent"],
        ...
        _layouts_default_default_component__WEBPACK_IMPORTED_MODULE_16__["DefaultComponent"],
        _layouts_default_toolbar_toolbar_component__WEBPACK_IMPORTED_MODULE_17__["ToolbarComponent"],
        _layouts_default_menubar_menubar_component__WEBPACK_IMPORTED_MODULE_18__["MenubarComponent"],
        _layouts_default_footer_footer_component__WEBPACK_IMPORTED_MODULE_19__["FooterComponent"],
        //   MeetRoomComponent,
        _video_room_video_room_component__WEBPACK_IMPORTED_MODULE_23__["VideoRoomComponent"],
        _meet_patient_meet_call_meet_call_component__WEBPACK_IMPORTED_MODULE_26__["MeetCallComponent"],
        _meet_patient_pay_patient_pay_patient_component__WEBPACK_IMPORTED_MODULE_27__["PayPatientComponent"],
        _meet_patient_wating_room_waiting_room_component__WEBPACK_IMPORTED_MODULE_28__["InviteBySms2"],
        _layouts_admin_admin_component__WEBPACK_IMPORTED_MODULE_24__["AdminComponent"],
        _meet_patient_meet_patient_component__WEBPACK_IMPORTED_MODULE_25__["MeetPatientComponent"],
        _meet_patient_wating_room_waiting_room_component__WEBPACK_IMPORTED_MODULE_28__["WaitingRoomComponent"],
        _meet_patient_feeback_feeback_component__WEBPACK_IMPORTED_MODULE_29__["FeebackComponent"]], imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"],
        _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_11__["BrowserAnimationsModule"],
        _demo_material_module__WEBPACK_IMPORTED_MODULE_12__["DemoMaterialModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_21__["FormsModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_21__["ReactiveFormsModule"],
        ...
        _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClientModule"],
        _shared_shared_module__WEBPACK_IMPORTED_MODULE_13__["SharedModule"],
        _ckeditor_ckeditor5_angular__WEBPACK_IMPORTED_MODULE_15__["CKEditorModule"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"]] }); })();
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](AppModule, [{
        ...
        args: [{
                declarations: [
                    ...
                    _meet_patient_meet_patient_component__WEBPACK_IMPORTED_MODULE_25__["MeetPatientComponent"],
                    _meet_patient_wating_room_waiting_room_component__WEBPACK_IMPORTED_MODULE_28__["WaitingRoomComponent"],
                    _meet_patient_feeback_feeback_component__WEBPACK_IMPORTED_MODULE_29__["FeebackComponent"]
                ],
                imports: [
                    _angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"],
                    _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_11__["BrowserAnimationsModule"],
...
/* harmony import */ var _helpers_auth_guard__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../_helpers/auth.guard */ "./src/app/_helpers/auth.guard.ts");
/* harmony import */ var _meet_patient_meet_patient_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./meet-patient/meet-patient.component */ "./src/app/pages/meet-patient/meet-patient.component.ts");
...
DefaultComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: DefaultComponent, selectors: [["app-default"]], decls: 24, vars: 5, consts: [[1, "main-container"], ["color", "primary", 1, "topbar", "telative"], [1, "navbar-header"], ["href", "index.html", 1, "navbar-brand"], ["src", "assets/images/logo.png", "alt", "homepage", 1, "dark-logo"], ["src", "assets/images/logo.png", "alt", "homepage", 1, "light-logo"], ["fxShow", "false", "fxShow.gt-xs", "", 1, "text-dark"], ["src", "assets/images/logo-text.png", "alt", "homepage", 1, "dark-logo"], ["mat-icon-button", "", "value", "sidebarclosed", 3, "click"], ["fxFlex", ""], [1, "example-sidenav-container"], ["id", "snav1", "fixedTopGap", "0", 1, "dark-sidebar", "pl-xs", 3, "mode", "opened", "disableClose"], ["snav1", ""], [1, "page-wrapper"], [1, "page-content"]], template: function DefaultComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DefaultComponent_Template_button_click_10_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r821); const _r820 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](17); return _r820.toggle(); });
...
function MenubarComponent_mat_list_item_1_a_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const menuitem_r824 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
...
function MenubarComponent_mat_list_item_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const menuitem_r824 = ctx.$implicit;
...
ToolbarComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ToolbarComponent, selectors: [["app-toolbar"]], decls: 23, vars: 1, consts: [[1, "toolbar"], ["routerLink", "/home", "routerLinkActive", "active-link", 1, "p-2"], ["routerLink", "/patient", "routerLinkActive", "active-link", 1, "p-2"], ["routerLink", "/provider", "routerLinkActive", "active-link", 1, "p-2"], ["routerLink", "/clinic", "routerLinkActive", "active-link", 1, "p-2"], ["routerLink", "/price", "routerLinkActive", "active-link", 1, "p-2"], ["routerLink", "/auth/sign-in", "mat-stroked-button", "", 1, "m-r-20", "hidden-sm-up", "bg-white", "text-black-50"], ["mat-stroked-button", "", 1, "m-r-20", "hidden-sm-up", "bg-white", "text-black-50", "w-p-180", 3, "matMenuTriggerFor"], [1, "w-p-180", "text-center", "mt-2", "mb-2"], ["afterMenu", "matMenu"], ["mat-raised-button", "", "routerLink", "/auth/sign-up/provider", 1, "bg-primary", "w-p-150", "mt-3", "p-3", "text-dark"], ["src", "https://img.icons8.com/doodle/48/000000/doctor-male.png", "alt", "doctor", 1, "w-25", "ml-n3"], ["mat-raised-button", "", "routerLink", "/auth/sign-in-patient", 1, "bg-info", "w-p-150", "mt-3", "p-3", "text-white-50"], ["src", "https://img.icons8.com/officel/16/000000/hospital-bed.png", "alt", "patient", 1, "ml-n3"]], template: function ToolbarComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        const _r822 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](16);
...
/* harmony import */ var _angular_flex_layout_extended__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/flex-layout/extended */ "./node_modules/@angular/flex-layout/__ivy_ngcc__/esm2015/extended.js");
/* harmony import */ var _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/flex-layout/flex */ "./node_modules/@angular/flex-layout/__ivy_ngcc__/esm2015/flex.js");
/* harmony import */ var _header_header_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./header/header.component */ "./src/app/pages/layouts/full/header/header.component.ts");
/* harmony import */ var _sidebar_sidebar_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./sidebar/sidebar.component */ "./src/app/pages/layouts/full/sidebar/sidebar.component.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
/* harmony import */ var _shared_spinner_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../shared/spinner.component */ "./src/app/pages/shared/spinner.component.ts");
...
FullComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: FullComponent, selectors: [["app-full-layout"]], decls: 19, vars: 5, consts: [[1, "main-container"], ["color", "primary", 1, "topbar", "telative"], [1, "navbar-header"], ["href", "index.html", 1, "navbar-brand"], ["fxShow", "false", "fxShow.gt-xs", "", 1, "text-dark"], ["mat-icon-button", "", "value", "sidebarclosed", 3, "click"], ["fxFlex", ""], [1, "example-sidenav-container"], ["id", "snav2", "fixedTopGap", "0", 1, "dark-sidebar", "pl-xs", 3, "mode", "opened", "disableClose"], ["snav2", ""], [1, "page-wrapper"], [1, "page-content"]], template: function FullComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function FullComponent_Template_button_click_6_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r102); const _r101 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵreference"](13); return _r101.toggle(); });
...
function AppHeaderComponent_ng_container_2_Template(rf, ctx) { if (rf & 1) {
    ...
    const ctx_r807 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
...
AppHeaderComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppHeaderComponent, selectors: [["app-header"]], decls: 9, vars: 3, consts: [["mat-icon-button", "", 1, "m-r-5", 3, "matMenuTriggerFor"], [4, "ngIf"], [1, "mymegamenu"], ["profile", "matMenu"], ["mat-menu-item", "", 3, "click"], ["src", "assets/images/users/1.jpg", "alt", "user", 1, "profile-pic"], ["alt", "user", 1, "profile-pic", 3, "src"]], template: function AppHeaderComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppHeaderComponent_Template_button_click_5_listener($event) { return ctx.logout(); });
        ...
        const _r808 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](4);
...
/* harmony import */ var _shared_accordion_accordion_directive__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../shared/accordion/accordion.directive */ "./src/app/pages/shared/accordion/accordion.directive.ts");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/common.js");
/* harmony import */ var _shared_accordion_accordionlink_directive__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../../shared/accordion/accordionlink.directive */ "./src/app/pages/shared/accordion/accordionlink.directive.ts");
/* harmony import */ var _shared_accordion_accordionanchor_directive__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../../shared/accordion/accordionanchor.directive */ "./src/app/pages/shared/accordion/accordionanchor.directive.ts");
...
function AppSidebarComponent_mat_list_item_2_a_1_ng_container_1_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
    ...
    const menuitem_r810 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2).$implicit;
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](menuitem_r810.icon);
} }
function AppSidebarComponent_mat_list_item_2_a_1_ng_container_2_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
...
function AppSidebarComponent_mat_list_item_2_a_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const menuitem_r810 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
...
function AppSidebarComponent_mat_list_item_2_Template(rf, ctx) { if (rf & 1) {
    ...
    const menuitem_r810 = ctx.$implicit;
...
AppSidebarComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppSidebarComponent, selectors: [["app-sidebar"]], outputs: { callOutput: "callOutput" }, decls: 3, vars: 1, consts: [["appAccordion", ""], ["appAccordionLink", "", "routerLinkActive", "selected", 3, "group", 4, "ngFor", "ngForOf"], ["appAccordionLink", "", "routerLinkActive", "selected", 3, "group"], ["class", "p-2 w-100", "appAccordionToggle", "", "routerLinkActive", "active-link", 3, "routerLink", "routerLinkActiveOptions", 4, "ngIf"], ["appAccordionToggle", "", "routerLinkActive", "active-link", 1, "p-2", "w-100", 3, "routerLink", "routerLinkActiveOptions"], [4, "ngIf"], [1, "ml-3"], ["fxFlex", ""], [3, "class", 4, "ngFor", "ngForOf"], [1, "super-icon-size", 3, "src"]], template: function AppSidebarComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
...
class FeebackComponent {
    constructor(formBuilder, feedback, _router) {
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](FeebackComponent, [{
    ...
    }], function () { return [{ type: _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"] }, { type: _services_feedback_service__WEBPACK_IMPORTED_MODULE_3__["FeedbackService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }]; }, { patientData: [{
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _services_provider_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../_services/provider.service */ "./src/app/_services/provider.service.ts");
...
/* harmony import */ var _services_patient_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./../../../_services/patient.service */ "./src/app/_services/patient.service.ts");
/* harmony import */ var _services_file_upload_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../_services/file-upload.service */ "./src/app/_services/file-upload.service.ts");
...
function MeetCallComponent_div_40_p_3_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function MeetCallComponent_div_40_p_3_Template_p_click_0_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r840); const i_r838 = ctx.index; const ctx_r839 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2); return ctx_r839.changeClass(i_r838, "down"); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} if (rf & 2) {
    const item_r837 = ctx.$implicit;
    const i_r838 = ctx.index;
    const ctx_r836 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2);
...
function MeetCallComponent_div_40_Template(rf, ctx) { if (rf & 1) {
    ...
    const ctx_r831 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();
...
function MeetCallComponent_div_41_p_3_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "p", 30);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function MeetCallComponent_div_41_p_3_Template_p_click_0_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r845); const i_r843 = ctx.index; const ctx_r844 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2); return ctx_r844.changeClass(i_r843, "up"); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} if (rf & 2) {
    const item_r842 = ctx.$implicit;
    const i_r843 = ctx.index;
...
function MeetCallComponent_div_48_Template(rf, ctx) { if (rf & 1) {
    ...
    const name_r846 = ctx.$implicit;
    const i_r847 = ctx.index;
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
...
function MeetCallComponent_ng_container_50_Template(rf, ctx) { if (rf & 1) {
    ...
    const file_r848 = ctx.$implicit;
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("value", file_r848.progress);
} }
class MeetCallComponent {
    constructor(providerService, meetRoomService, formBuilder, renderer, fileUploadService, patientService) {
        this.providerService = providerService;
        this.meetRoomService = meetRoomService;
        this.formBuilder = formBuilder;
    ...
    uploadFile(file) {
        ...
        this.fileUploadService.uploadFile(formData).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(event => {
            /*console.log('event')
            console.log(event)*/
            switch (event.type) {
    ...
    handleDownload() {
        if (this.downloadFile) {
            this.patientService.download('file-transfer/download/consult/' + this.downloadFile)
                .subscribe(blob => {
                Object(file_saver__WEBPACK_IMPORTED_MODULE_9__["saveAs"])(blob, this.downloadFile);
            });
        }
    }
}
...
MeetCallComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: MeetCallComponent, selectors: [["app-meet-call"]], viewQuery: function MeetCallComponent_Query(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function MeetCallComponent_Template_form_ngSubmit_27_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r849); const _r830 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](32); ctx.sendText(); return _r830.value = ""; });
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](MeetCallComponent, [{
    ...
    }], function () { return [{ type: _services_provider_service__WEBPACK_IMPORTED_MODULE_1__["ProviderService"] }, { type: _services_meet_room_service__WEBPACK_IMPORTED_MODULE_2__["MeetRoomService"] }, { type: _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"] }, { type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Renderer2"] }, { type: _services_file_upload_service__WEBPACK_IMPORTED_MODULE_8__["FileUploadService"] }, { type: _services_patient_service__WEBPACK_IMPORTED_MODULE_7__["PatientService"] }]; }, { fileUpload: [{
...
function MeetPatientComponent_div_23_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
...
function MeetPatientComponent_div_24_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
...
function MeetPatientComponent_div_25_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
...
class MeetPatientComponent {
    constructor(route, meetRoomService, providerService, authPatientService, _router) {
        this.route = route;
        this.meetRoomService = meetRoomService;
        this.providerService = providerService;
        ...
        this.patientData['providerId'] = this.providerData._id;
        this.providerService.updatePatient(this.patientData).subscribe((patientUpdated) => {
...
MeetPatientComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: MeetPatientComponent, selectors: [["app-meet-patient"]], decls: 27, vars: 7, consts: [[1, "room-container"], ["mode", "side", "opened", "", 1, "room-sidebar"], [1, "p-3", "mt-4"], ["href", "index.html", 1, ""], ["src", "assets/images/logo.png", "alt", "homepage", 1, "w-25"], ["fxShow", "false", "fxShow.gt-xs", "", 1, "text-dark", "ml-4", "font-weight-bold"], [1, "font-weight-bold", "text-dark", "mt-5"], [1, "d-flex", "justify-content-around", "mt-2"], [4, "ngIf"], [1, "font-weight-bold", "text-dark"], [1, "mt-3"], [1, "container-fluid"], ["alt", "provider", 1, "profile-image", 3, "src"], [1, "d-block"], [1, "font-weight-bold", "text-blue"], [1, "font-weight-bold", "text-warning"], [3, "patientData", "providerData", "roomName"]], template: function MeetPatientComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](MeetPatientComponent, [{
    ...
    }], function () { return [{ type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"] }, { type: _services_meet_room_service__WEBPACK_IMPORTED_MODULE_2__["MeetRoomService"] }, { type: _services_provider_service__WEBPACK_IMPORTED_MODULE_3__["ProviderService"] }, { type: _services_auth_patient_service__WEBPACK_IMPORTED_MODULE_4__["AuthPatientService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"] }]; }, null); })();
...
function PayPatientComponent_div_15_Template(rf, ctx) { if (rf & 1) {
    ...
    const ctx_r851 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);
...
function PayPatientComponent_div_16_Template(rf, ctx) { if (rf & 1) {
    ...
    const ctx_r852 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);
...
function PayPatientComponent_div_17_Template(rf, ctx) { if (rf & 1) {
    ...
    const ctx_r853 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](3);
...
function PayPatientComponent_div_18_Template(rf, ctx) { if (rf & 1) {
    ...
    const ctx_r854 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](3);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngForOf", ctx_r854.payData.url);
} }
class PayPatientComponent {
    constructor(formBuilder, meetRoomService, userService, _route) {
        this.formBuilder = formBuilder;
        this.meetRoomService = meetRoomService;
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](PayPatientComponent, [{
    ...
    }], function () { return [{ type: _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormBuilder"] }, { type: _services_meet_room_service__WEBPACK_IMPORTED_MODULE_2__["MeetRoomService"] }, { type: _services_user_service__WEBPACK_IMPORTED_MODULE_3__["UserService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"] }]; }, { localVideo: [{
            type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"],
            args: ['localVideo']
        }], patientData: [{
            type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"]
...
/* harmony import */ var _config_constant__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../_config/constant */ "./src/app/_config/constant.ts");
/* harmony import */ var _services_meet_room_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../_services/meet-room.service */ "./src/app/_services/meet-room.service.ts");
...
/* harmony import */ var _services_content_blog_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../_services/content-blog.service */ "./src/app/_services/content-blog.service.ts");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/common.js");
...
class WaitingRoomComponent {
    constructor(dialog, providerService, meetRoomService, _router, userService, contentBlogService) {
        this.dialog = dialog;
        this.providerService = providerService;
        this.meetRoomService = meetRoomService;
        this._router = _router;
...
WaitingRoomComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: WaitingRoomComponent, selectors: [["app-waiting"]], viewQuery: function WaitingRoomComponent_Query(rf, ctx) { if (rf & 1) {
        ...
        const _r860 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](17);
        const _r861 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](25);
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](WaitingRoomComponent, [{
    ...
    }], function () { return [{ type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialog"] }, { type: _services_provider_service__WEBPACK_IMPORTED_MODULE_3__["ProviderService"] }, { type: _services_meet_room_service__WEBPACK_IMPORTED_MODULE_6__["MeetRoomService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"] }, { type: _services_user_service__WEBPACK_IMPORTED_MODULE_7__["UserService"] }, { type: _services_content_blog_service__WEBPACK_IMPORTED_MODULE_8__["ContentBlogService"] }]; }, { localVideo: [{
            type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"],
            args: ['localVideo']
        }], patientData: [{
            type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"]
...
InviteBySms2.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: InviteBySms2, selectors: [["invite-by-sms2"]], decls: 21, vars: 9, consts: [["mat-dialog-content", ""], [1, "mb-3"], ["type", "text", "ng2TelInput", "", "matInput", "", "id", "phoneNumber", "name", "phoneNumber", 1, "form-control", "text-dark", "w-p-350", 3, "ngModel", "ngClass", "ngModelChange", "hasError", "ng2TelOutput"], ["phoneNumber", "ngModel"], [4, "ngIf"], [1, "mt-3"], ["matInput", "", "type", "text", 3, "ngModel", "ngModelChange"], ["mat-dialog-actions", "", 1, "d-flex", "justify-content-between"], ["mat-flat-button", "", "color", "accent", 3, "click"], ["mat-raised-button", "", "color", "primary", 3, "click"], [1, "d-block", "invalid-feedback", "mt-3"]], template: function InviteBySms2_Template(rf, ctx) { if (rf & 1) {
        ...
        const _r866 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](5);
...
module.exports = __webpack_require__(/*! F:\tttttt\MedicalVideoConsultancy\src\main.ts */"./src/main.ts");
